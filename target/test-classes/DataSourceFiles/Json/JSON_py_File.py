...
def calculate_metric(metrics,data):
    ...
    '''
    for key in data:
        metrics["Interns"] = data[key][data[key]["TITLE"] == r"Intern"].shape[0]
        metrics["Apprentice"] = data[key][data[key]["TITLE"] == r"apprentice"].shape[0]
        metrics["Female"] = data[key][data[key]["GENDER"] == r"Female"].shape[0]
